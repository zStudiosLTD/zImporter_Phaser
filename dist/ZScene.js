...
export class ZScene {
        ...
        for (const childNode of baseNode.children) {
            ...
            if (type === "inputField") {
                try {
                    ...
                    textInput.currentTransform = leafTransform;
                    textInput.portrait = leafTransform;
                    textInput.landscape = leafTransform;
     ...
     */
    addSpineSlotAttachment(attachment, spineObj, parent) {
        const instanceData = attachment.assetData;
